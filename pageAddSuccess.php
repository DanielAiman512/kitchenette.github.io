...
<div class="w3-container" style="padding:128px 16px" id="about">
  ...
  <div class="container">
    ...
    <?php 
		...
		$add_SPass=$_POST['txtSPass'];
		$add_SName=$_POST['txtSName']; 
		$add_STel=$_POST['txtSTel']; 
	   
		$query= "INSERT INTO staff(STAFF_ID,PASSWORD,STAFF_NAME,STAFF_PHONE_NUM) VALUES ('$add_SId','$add_SPass','$add_SName','$add_STel')" ;		
