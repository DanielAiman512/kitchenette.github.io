...
<div class="w3-container" style="padding:128px 16px" id="about">
  ...
  <form action="pageAddSuccess.php" method="post" style="border:1px solid #ccc">
  <div class="container">
    <h1>Sign Up</h1>
    ...
    <input type="text" placeholder="Enter New Staff ID" name="txtSId" required>
	
    <label for="psw"><b>Password</b></label>
    <input type="password" placeholder="Enter Password" name="txtSPass" required id="myInput">

	<label for="SName"><b>Staff Name</b></label>
    <input type="text" placeholder="Enter Staff Name" name="txtSName" required>
	
	<label for="STel"><b>Staff Phone Number</b></label>
    <input type="text" placeholder="Enter Staff Phone Number" name="txtSTel" required>
	
    <label>
      <input type="checkbox" name="show" style="margin-bottom:15px" onclick="myFunction()"> Show Password
    </label>
	...
	<span class="psw">Already register? <a href="pageStaffLogin.php"> Login</a></span>
  </div>
</form>
