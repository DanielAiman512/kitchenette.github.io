...
<nav class="w3-sidebar w3-bar-block w3-black w3-card w3-animate-left w3-hide-medium w3-hide-large" style="display:none" id="mySidebar">
  ...
  <a href="index.html#work" onclick="w3_close()" class="w3-bar-item w3-button">DESIGN</a>
  <a href="index.html#contact" onclick="w3_close()" class="w3-bar-item w3-button">CONTACT</a>
  <a href="pagePurchases.html" onclick="w3_close()" class="w3-bar-item w3-button">PURCHASE</a>
  <a href="pageStaffLogin.html" onclick="w3_close()" class="w3-bar-item w3-button">STAFF</a>
</nav>
...
<div class="w3-container" style="padding:128px 16px" id="about">
  ...
  <div class="container">
    ...
    <input name="staffId" type="text" id="user" placeholder="Enter Username" required>

    <label for="psw"><b>Password</b></label>
    <input name="psw" id="user" type="password" placeholder="Enter Password" required id="myInput">
  ...
  <div class="container" style="background-color:#f1f1f1">
    <button type="button" class="cancelbtn"><a href="index.php" style="text-decoration: none;">Back</a></button>
    <span class="psw">New staff? <a href="pageStaffRegister.php"> Register</a> </span> 
  </div>
</form>
