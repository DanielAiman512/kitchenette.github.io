...
<div class="w3-container" style="padding:128px 16px" id="about">
  <h1 class="w3-center">CUSTOMER PURCHASE</h1>
  <form action="pagePurchaseSuccess.php" method="post" style="border:1px solid #ccc">
  <div class="container">
    <h1>Purchase</h1>
	<p>Please fill in this form to make a purchase.</p>
    <hr>

    <label for="OId"><b>Order ID</b></label>
    <input type="text" placeholder="Enter New Order ID" name="txtOId" required>
	
	<label for="CId"><b>Customer ID</b></label>
    <input type="text" placeholder="Enter New Customer ID" name="txtCId" required>
	
	<label for="CName"><b>Customer Name</b></label>
    <input type="text" placeholder="Enter New Customer Name" name="txtCName" required>
	
	<label for="CTel"><b>Customer Phone Number</b></label>
    <input type="text" placeholder="Enter New Customer Phone Number" name="txtCTel" required>
	
	<label for="pack"><b>Package</b></label>
    <input type="text" placeholder="Enter Package Selected" name="txtPack" required>
	
	<label for="packP"><b>Package Price</b></label>
    <input type="text" placeholder="Enter Package Selected Price" name="txtPackP" required>
	
	<label for="RWidth"><b>Room Width</b></label>
    <input type="text" placeholder="Enter Room Width" name="txtRWidth">
	
	<label for="RLength"><b>Room Length</b></label>
    <input type="text" placeholder="Enter Room Length" name="txtRLength">
	
	<label for="SId"><b>Staff ID</b></label>
    <input type="text" placeholder="Enter Staff Id" name="txtSId">
    
    <div class="clearfix">
      <button type="button" class="cancelbtn"><a href="index.php" style="text-decoration: none;">Cancel</button>
      <button type="submit" class="signupbtn">Make a Purchase</button>
    </div>
  </div>
</form>
