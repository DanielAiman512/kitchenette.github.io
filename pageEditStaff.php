...
<div class="w3-container" style="padding:128px 16px" id="about">
  <h1 class="w3-center">STAFF DETAILS</h1>
  <form action="pageEditSuccess.php" method="post" style="border:1px solid #ccc">
  <div class="container">
	...
	<?php while ( $user = mysqli_fetch_array( $result ))
	{
		$SId=$user['STAFF_ID'];
		$SPass=$user['PASSWORD'];
		$SName= $user['STAFF_NAME'];
		$STel= $user['STAFF_PHONE_NUM'];
	}
	?>
	
    <label for="SId"><b>Staff ID</b></label>
    <input type="text" name="txtSId" value="<?php echo $id ?>" required>
	
    <label for="psw"><b>Password</b></label>
    <input type="password" value="<?php echo $SPass ?>" name="txtSPass" required id="myInput">

	<label for="SName"><b>Staff Name</b></label>
    <input type="text" value="<?php echo $SName ?>" name="txtSName" required>
	
	<label for="STel"><b>Staff Phone Number</b></label>
    <input type="text" value="<?php echo $STel ?>" name="txtSTel" required>
