...
<div class="w3-container" style="padding:128px 16px" id="about">
  <h1 class="w3-center">CUSTOMER PURCHASES</h1>
  ...
  <div class="container">
    ...
    <?php 
		...
		$add_OId=$_POST['txtOId']; 
		$add_CId=$_POST['txtCId'];
		$add_CName=$_POST['txtCName']; 
		$add_CTel=$_POST['txtCTel']; 
		$add_Pack=$_POST['txtPack']; 
		$add_PackP=$_POST['txtPackP'];
		$add_RWidth=$_POST['txtRWidth']; 
		$add_RLength=$_POST['txtRLength'];
		$add_SId=$_POST['txtSId'];
		
		
		$query= "INSERT INTO order_detail(ORDER_ID,CUST_ID,CUST_NAME,CUST_PHONE_NUM,PACKAGE,PACKAGE_PRICE,ROOM_WIDTH,ROOM_LENGTH,STAFF_ID) VALUES ('$add_OId','$add_CId','$add_CName','$add_CTel','$add_Pack','$add_PackP','$add_RWidth','$add_RLength','$add_SId')";		
		...
		include 'db_connect.php';
			$detail=$_REQUEST["txtOId"];
			
			$query = "Select * from order_detail WHERE ORDER_ID LIKE '$detail' order by  ORDER_ID Asc";
			$result2 = mysqli_query( $link,$query) or die("Query failed");
		?>
